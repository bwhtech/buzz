...
<template>
	<button
		type="button"
		class="flex w-full flex-col gap-2 rounded-4 border border-outline-gray-2 p-4 text-left transition-colors enabled:hover:bg-surface-gray-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outline-gray-3 disabled:cursor-default"
