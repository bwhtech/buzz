...
(function (a, n) {
	...
	const n = {
		...
		iA = (t) => Array.from(t.attributes).reduce((h, d) => ((h[d.name] = d.value), h), {}),
		Ba = (t) =>
			typeof t == "string"
				? t
				: !t || !t.class
		...
		za = (t, { nameAttr: h, icons: d, attrs: c }) => {
			...
			const fa = iA(t),
				nA = dA(fa) ? {} : { "aria-hidden": "true" },
				tA = { ...n, "data-lucide": M, ...nA, ...c, ...fa },
				lA = Ba(fa),
				eA = Ba(c),
				hA = cA("lucide", `lucide-${M}`, ...lA, ...eA);
			hA && Object.assign(tA, { class: hA });
			const rA = Pa(La, tA);
			return t.parentNode?.replaceChild(rA, t);
		},
		Fa = [
		...
		Uc = [["ellipse", { cx: "12", cy: "12", rx: "10", ry: "6" }]],
		Oc = [["path", { d: "M12 2C8 2 4 8 4 14a8 8 0 0 0 16 0c0-6-4-12-8-12" }]],
		R1 = [
			["circle", { cx: "12", cy: "12", r: "1" }],
		...
		ue = [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z" }]],
		Ae = [
			["path", { d: "M12 7.318V10" }],
		...
		Qe = [["polygon", { points: "3 11 22 2 13 21 11 13 3 11" }]],
		Je = [
		...
		qo = [
			[
				"path",
				{ d: "M13 17a1 1 0 1 0-2 0l.5 4.5a0.5 0.5 0 0 0 1 0z", fill: "currentColor" },
			],
		...
		Vv = [["rect", { width: "20", height: "12", x: "2", y: "6", rx: "2" }]],
		wv = [["rect", { width: "12", height: "20", x: "6", y: "2", rx: "2" }]],
		Sv = [
			[
				"path",
				{
		...
		cy = [["path", { d: "M22 17v1c0 .5-.5 1-1 1H3c-.5 0-1-.5-1-1v-1" }]],
		My = [
			["path", { d: "M12 21a9 9 0 0 0 9-9H3a9 9 0 0 0 9 9Z" }],
			["path", { d: "M7 21h10" }],
		...
		Fy = [["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2" }]],
		Dy = [
			[
				"path",
				{
		...
		Ty = [["path", { d: "M12 3c7.2 0 9 1.8 9 9s-1.8 9-9 9-9-1.8-9-9 1.8-9 9-9" }]],
		Uy = [
		...
		tg = [["path", { d: "M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z" }]],
		hg = [
			[
				"path",
				{
	...
	var xu = Object.freeze({
		...
		GitPullRequestClosed: sM,
		GitPullRequestCreate: yM,
		GitPullRequestCreateArrow: mM,
		GitPullRequestDraft: CM,
		GlassWater: uM,
		Glasses: AM,
		Globe: SM,
		Globe2: D1,
		...
		Merge: ol,
		MessageCircle: Vl,
		MessageCircleCheck: vl,
		MessageCircleCode: $l,
		MessageCircleDashed: ml,
		MessageCircleHeart: yl,
		MessageCircleMore: sl,
		MessageCircleOff: gl,
		MessageCirclePlus: Cl,
		MessageCircleQuestion: P2,
		MessageCircleQuestionMark: P2,
		MessageCircleReply: ul,
		MessageCircleWarning: Al,
		MessageCircleX: Hl,
		MessageSquare: Zl,
		MessageSquareCheck: wl,
		MessageSquareCode: Sl,
		MessageSquareDashed: Ll,
		MessageSquareDiff: fl,
		MessageSquareDot: kl,
		MessageSquareHeart: Pl,
		MessageSquareLock: Bl,
		MessageSquareMore: zl,
		MessageSquareOff: Fl,
		MessageSquarePlus: Dl,
		MessageSquareQuote: Rl,
		MessageSquareReply: ql,
		MessageSquareShare: bl,
		MessageSquareText: Tl,
		MessageSquareWarning: Ul,
		MessageSquareX: Ol,
		MessagesSquare: Gl,
		Metronome: Wl,
		Mic: Il,
		...
		ReceiptCent: rv,
		ReceiptEuro: ov,
		ReceiptIndianRupee: vv,
		ReceiptJapaneseYen: $v,
		ReceiptPoundSterling: mv,
		ReceiptRussianRuble: yv,
		ReceiptSwissFranc: sv,
		ReceiptText: gv,
		ReceiptTurkishLira: Cv,
		RectangleCircle: uv,
		RectangleEllipsis: N2,
		RectangleGoggles: Hv,
		RectangleHorizontal: Vv,
		RectangleVertical: wv,
		Recycle: Sv,
		Redo: kv,
		Redo2: Lv,
		RedoDot: fv,
		...
		Slice: jm,
		Sliders: t0,
		SlidersHorizontal: Km,
		SlidersVertical: t0,
		Smartphone: Jm,
		SmartphoneCharging: Nm,
		SmartphoneNfc: Qm,
		Smile: _m,
		SmilePlus: Ym,
		Snail: xm,
		Snowflake: ay,
		SoapDispenserDroplet: hy,
		Sofa: ty,
		SolarPanel: dy,
		SortAsc: S,
		SortDesc: H,
		...
		SquareArrowRight: o0,
		SquareArrowRightEnter: uy,
		SquareArrowRightExit: Ay,
		SquareArrowUp: m0,
		SquareArrowUpLeft: $0,
		...
		SquareCode: L0,
		SquareDashed: P0,
		SquareDashedBottom: Vy,
		SquareDashedBottomCode: Hy,
		SquareDashedKanban: f0,
		SquareDashedMousePointer: k0,
		SquareDashedText: y,
		SquareDashedTopSolid: wy,
		SquareDivide: B0,
		SquareDot: z0,
		SquareEqual: F0,
		SquareFunction: D0,
...
lucide.createIcons({icons});\``);
		...
		if (
			...
			M &&
				Array.from(c.querySelectorAll("template")).forEach((p) =>
					aA({ icons: t, nameAttr: h, attrs: d, root: p.content, inTemplates: M })
				),
			h === "data-lucide")
		) {
	...
	(a.AArrowDown = Fa),
		...
		(a.AlignVerticalJustifyStart = lt),
		...
		(a.ChevronsLeftRightEllipsis = Hd),
		(a.ChevronsRight = Ld),
		...
		(a.CornerLeftDown = A8),
		(a.CornerLeftUp = V8),
		(a.CornerRightDown = H8),
		(a.CornerRightUp = w8),
		(a.CornerUpLeft = S8),
		(a.CornerUpRight = L8),
		(a.Cpu = f8),
		(a.CreativeCommons = k8),
		(a.CreditCard = P8),
		(a.Croissant = B8),
		(a.Crop = z8),
		(a.Cross = F8),
		...
		(a.GitGraph = rM),
		(a.GitMerge = oM),
		(a.GitMergeConflict = vM),
		(a.GitPullRequest = gM),
		(a.GitPullRequestArrow = $M),
		(a.GitPullRequestClosed = sM),
		(a.GitPullRequestCreate = yM),
		(a.GitPullRequestCreateArrow = mM),
		(a.GitPullRequestDraft = CM),
		(a.GlassWater = uM),
		(a.Glasses = AM),
		(a.Globe = SM),
		(a.Globe2 = D1),
		...
		(a.LayersPlus = Li),
		(a.Layout = E2),
		(a.LayoutDashboard = fi),
		(a.LayoutGrid = ki),
		(a.LayoutList = Pi),
		(a.LayoutPanelLeft = Bi),
		(a.LayoutPanelTop = zi),
		(a.LayoutTemplate = Fi),
		(a.Leaf = Di),
		(a.LeafyGreen = Ri),
		...
		(a.Merge = ol),
		(a.MessageCircle = Vl),
		(a.MessageCircleCheck = vl),
		(a.MessageCircleCode = $l),
		(a.MessageCircleDashed = ml),
		(a.MessageCircleHeart = yl),
		(a.MessageCircleMore = sl),
		(a.MessageCircleOff = gl),
		(a.MessageCirclePlus = Cl),
		(a.MessageCircleQuestion = P2),
		(a.MessageCircleQuestionMark = P2),
		(a.MessageCircleReply = ul),
		(a.MessageCircleWarning = Al),
		(a.MessageCircleX = Hl),
		(a.MessageSquare = Zl),
		(a.MessageSquareCheck = wl),
		(a.MessageSquareCode = Sl),
		(a.MessageSquareDashed = Ll),
		(a.MessageSquareDiff = fl),
		(a.MessageSquareDot = kl),
		(a.MessageSquareHeart = Pl),
		(a.MessageSquareLock = Bl),
		(a.MessageSquareMore = zl),
		(a.MessageSquareOff = Fl),
		(a.MessageSquarePlus = Dl),
		(a.MessageSquareQuote = Rl),
		(a.MessageSquareReply = ql),
		(a.MessageSquareShare = bl),
		(a.MessageSquareText = Tl),
		(a.MessageSquareWarning = Ul),
		(a.MessageSquareX = Ol),
		(a.MessagesSquare = Gl),
		(a.Metronome = Wl),
		(a.Mic = Il),
		...
		(a.MousePointer = ke),
		(a.MousePointer2 = Se),
		(a.MousePointer2Off = Ve),
		(a.MousePointerBan = we),
		...
		(a.PanelRight = Rr),
		(a.PanelRightClose = Fr),
		(a.PanelRightDashed = G2),
		(a.PanelRightInactive = G2),
		(a.PanelRightOpen = Dr),
		(a.PanelTop = Ur),
		(a.PanelTopBottomDashed = qr),
		(a.PanelTopClose = br),
		(a.PanelTopDashed = W2),
		(a.PanelTopInactive = W2),
		(a.PanelTopOpen = Tr),
		(a.PanelsLeftBottom = Or),
		(a.PanelsLeftRight = B1),
		(a.PanelsRightBottom = Zr),
		...
		(a.Piano = vo),
		(a.Pickaxe = $o),
		(a.PictureInPicture = yo),
		(a.PictureInPicture2 = mo),
		(a.PieChart = j),
		(a.PiggyBank = so),
		(a.Pilcrow = uo),
		(a.PilcrowLeft = go),
		...
		(a.ReceiptCent = rv),
		(a.ReceiptEuro = ov),
		(a.ReceiptIndianRupee = vv),
		(a.ReceiptJapaneseYen = $v),
		(a.ReceiptPoundSterling = mv),
		(a.ReceiptRussianRuble = yv),
		(a.ReceiptSwissFranc = sv),
		(a.ReceiptText = gv),
		(a.ReceiptTurkishLira = Cv),
		(a.RectangleCircle = uv),
		(a.RectangleEllipsis = N2),
		(a.RectangleGoggles = Hv),
		(a.RectangleHorizontal = Vv),
		(a.RectangleVertical = wv),
		(a.Recycle = Sv),
		(a.Redo = kv),
		(a.Redo2 = Lv),
		(a.RedoDot = fv),
		...
		(a.SendHorizontal = _2),
		(a.SendToBack = X$),
		(a.SeparatorHorizontal = N$),
		(a.SeparatorVertical = K$),
		(a.Server = _$),
		(a.ServerCog = Q$),
		(a.ServerCrash = J$),
		(a.ServerOff = Y$),
		...
		(a.Slice = jm),
		(a.Sliders = t0),
		(a.SlidersHorizontal = Km),
		(a.SlidersVertical = t0),
		(a.Smartphone = Jm),
		(a.SmartphoneCharging = Nm),
		(a.SmartphoneNfc = Qm),
		(a.Smile = _m),
		(a.SmilePlus = Ym),
		(a.Snail = xm),
		(a.Snowflake = ay),
		(a.SoapDispenserDroplet = hy),
		(a.Sofa = ty),
		(a.SolarPanel = dy),
		(a.SortAsc = S),
		(a.SortDesc = H),
		...
		(a.SquareArrowRightEnter = uy),
		(a.SquareArrowRightExit = Ay),
		(a.SquareArrowUp = m0),
		(a.SquareArrowUpLeft = $0),
		...
		(a.SquareCode = L0),
		(a.SquareDashed = P0),
		(a.SquareDashedBottom = Vy),
		(a.SquareDashedBottomCode = Hy),
		(a.SquareDashedKanban = f0),
		(a.SquareDashedMousePointer = k0),
		(a.SquareDashedText = y),
		(a.SquareDashedTopSolid = wy),
		(a.SquareDivide = B0),
		(a.SquareDot = z0),
		(a.SquareEqual = F0),
		(a.SquareFunction = D0),
		...
		(a.Sticker = Ny),
		(a.StickyNote = xy),
		(a.StickyNoteCheck = Ky),
		(a.StickyNoteMinus = Qy),
		(a.StickyNoteOff = Jy),
		(a.StickyNotePlus = Yy),
		(a.StickyNoteX = _y),
		(a.StickyNotes = as),
		...
		(a.Table = ks),
		(a.Table2 = Hs),
		(a.TableCellsMerge = As),
		(a.TableCellsSplit = Vs),
		(a.TableColumnsSplit = ws),
		(a.TableConfig = e),
		(a.TableOfContents = Ss),
		(a.TableProperties = Ls),
		(a.TableRowsSplit = fs),
		(a.Tablet = Bs),
		(a.TabletSmartphone = Ps),
		(a.Tablets = zs),
		(a.Tag = Fs),
		(a.Tags = Ds),
		(a.Tally1 = Rs),
		...
		(a.TestTubes = js),
		(a.Text = s),
		(a.TextAlignCenter = Ma),
		(a.TextAlignEnd = ca),
		(a.TextAlignJustify = pa),
		(a.TextAlignStart = s),
		(a.TextCursor = Ns),
		(a.TextCursorInput = Ks),
		(a.TextInitial = ia),
		(a.TextQuote = Qs),
		(a.TextSearch = Js),
		(a.TextSelect = y),
		...
		(a.ZodiacAries = Uu),
		(a.ZodiacCancer = Zu),
		(a.ZodiacCapricorn = Gu),
		(a.ZodiacGemini = Wu),
		(a.ZodiacLeo = Eu),
		(a.ZodiacLibra = Iu),
		(a.ZodiacOphiuchus = Xu),
		(a.ZodiacPisces = ju),
		(a.ZodiacSagittarius = Nu),
		(a.ZodiacScorpio = Ku),
		(a.ZodiacTaurus = Qu),
		(a.ZodiacVirgo = Yu),
		(a.ZoomIn = Ju),
